...
knitr::kable(account[1:5,], caption = 'accounts frame')
...
knitr::kable(client[1:5,], caption = 'clients frame')
```
...
knitr::kable(disposition[1:5,], caption = 'disposition frame')
...
knitr::kable(order[1:5,], caption = 'order frame')
```
...
Transaction (credit card withdrawal, credit in cash, collection from another bank, withdrawal in cash, remittance to another bank)
...
knitr::kable(transaction[1:5,], caption = 'transaction frame')
```
...
knitr::kable(loan[1:5,], caption = 'loan frame')
```
...
knitr::kable(card[1:5,], caption = 'card frame')
```
...
n <- c("district_id","district_name","region","inhabitants","n_size_1",
       ...
       "average salary","unemployment rate '95","unemployment rate '96",
       "entrepreneurs per 1000 inhabitants","committed crimes '95","committed crimes '96")
...
knitr::kable(prev[1:5,], caption = 'demographic frame')
```

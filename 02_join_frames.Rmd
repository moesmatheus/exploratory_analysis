...
1. Aggregate every table but the transactions in which the granularity was the account, the clients were agregated to show only the account owner and the number of the dependants in the account. 
...
#Join order
frame_order <- left_join(frame_no_transaction,order, by = 'account_id') 
